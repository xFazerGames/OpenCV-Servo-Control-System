...
while True: 
    ...
    if ret: 
        ...
        frameHSV = cv2.cvColor(frame, cv2.COLOR_BGR2HSV)
        ...
        for c in contornos:
            ...
            if area > 6000:
                ...
                if x < 200:
                    print("Moviendo a la izquierda 100%")
                    ser.write(b"izq1\n")
                elif 420 > x >= 200:
                    print("Moviendo a la izquierda 60%")
                    ser.write(b"izq2\n")
                elif 520 > x >= 420:
                    print("Moviendo a la izquierda 30%")
                    ser.write(b"izq3\n")
                elif 520 <= x < 650:
